...
// Cloudinary Ayarlarýný Yükleyin
var cloudinarySettings = builder.Configuration.GetSection("Cloudinary").Get<CloudinaryDotNet.Account>();
if (cloudinarySettings == null ||
    string.IsNullOrWhiteSpace(cloudinarySettings.Cloud) ||
    string.IsNullOrWhiteSpace(cloudinarySettings.ApiKey) ||
    string.IsNullOrWhiteSpace(cloudinarySettings.ApiSecret))
{
    throw new ArgumentException("Cloudinary ayarlarý eksik veya yanlýþ.");
}
